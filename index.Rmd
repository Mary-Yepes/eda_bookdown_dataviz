...
cat("Mejor modelo:         ", mejor$Metodo, "\n")
cat("Técnica de balanceo:  ", mejor$Tecnica_Balanceo, "\n")
cat("Test F1:              ", round(mejor$Test_F1, 4), "\n")
cat("Test ROC AUC:         ", round(mejor$Test_ROC_AUC, 4), "\n")
cat("Test Recall:          ", round(mejor$Test_Recall, 4), "\n")
cat("Test Precision:       ", round(mejor$Test_Precision, 4), "\n")
```
...
p_cm <- suppressWarnings(autoplot(cm, type = "heatmap") +
  scale_fill_gradient(low = "white", high = "steelblue") +
  labs(title = "Matriz de Confusión — XGBoost — Optuna — ADASYN") +
  theme_bw() +
  theme(plot.title = element_text(size = 11)))
